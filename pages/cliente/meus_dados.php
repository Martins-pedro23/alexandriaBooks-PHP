...
$sql = "SELECT * FROM Cliente cl INNER JOIN Imagem_Cliente img on cl.ID_Cliente = img.ID_Cliente WHERE Email = '$email' AND Senha = '$senha'";
...
require "../../sources/navbar.php"; 
    ...
    <div id="info_usuario">
        <div id="img_bot">
            <img id="img_user" src="<?=$registro['Caminho_Img_Cliente']?>" alt="">
            <div id="bot_cliente">
        ...
        <div id="dados_cliente">
            <p>Nome:</p><div class="dados"><?=$registro['Nome']?></div>
            <p>CPF:</p><div class="dados"><?=$registro['CPF']?></div>
            <p>Nascimento:</p><div class="dados"><?=$registro['DT_Nasc']?></div>
            <p>E-mail:</p><div class="dados"><?=$registro['Email']?></div>
        </div>
